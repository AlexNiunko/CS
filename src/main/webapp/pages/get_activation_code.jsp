...
<html lang="ru">
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath}/pages/css/style_get_activation_code.css" />
		...
		<div class="wrapper">
			...
			<div class="main">
				...
				<div class="main__button">
					<input type="hidden" name="command" value="get_activation_code_command"/>
					<input type="submit" class="button__registration" name="button_get_activation_code_command" value="Get activation code" />
				</div>
<%--				<div class="registration__message" style="color: red" >--%>
<%--					<c:if test="${!empty if_user_exist}">--%>
<%--						${if_user_exist}--%>
<%--					</c:if>--%>
<%--				</div>--%>
			</div>
