...
<html lang="ru">
		...
		<link rel="stylesheet" href="css/orders_page_mooving.css" />
		...
		<div class="wrapper">
			<header class="header">
				...
				<div class="header__emblem">
					<img src="img/emblem/3.jpg" alt="">
				</div>
					<div class="header__login ">	
					<form action="#">
						<input type="hidden" name="command" value="Logout"/>
						<input type="submit" class="button" name="push" value ="Logout"/>
					</form>
					</div>
				</div>
			</header>
			<main class="main">
				...
				<section class="content">
					<h2 class="content_title">Your order</h2>
						...
						<div class="method">card 9999 9999 9999 9999</div>
						<div class="change_method">
							<form action="#">
								<input type="hidden" name="command" value="Your profile"/>
								<input type="submit" class="button" name="push" value ="Change payment"/>
							</form>
						</div>
						<h2 class="time_start_driving">Time start</h2>
						<div class="time_start">01.02.2023 15.00</div>

						<div class="current_amount_button">
							<form action="#">
								<input type="hidden" name="command" value="Your profile"/>
								<input type="submit" class="button" name="push" value ="Current amount"/>
							</form>
						</div>
						<div class="current_amount">9999.99 blr</div>
						<div class="stop_button">
							<form action="#">
								<input type="hidden" name="command" value="Your profile"/>
								<input type="submit" class="button" name="push" value ="Stop driving"/>
							</form>
						</div>
